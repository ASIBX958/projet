...
produits = [
    ...
    {'id': 7, 'nom': 'HP Ecran Tactile', 'description': 'HP Ecran Tactile', 'prix': ('599 900'),'image':"img/hp-envy-14-2-en-1-tactile-amd-ryzen-7-16gb-ram-1tb-ssd-gris-garantie-06-mois.jpg"},
    {'id': 8, 'nom': 'Nasco Refrigerateur', 'description': 'Nasco Refrigerateur', 'prix': ('169 900'),'image':"img/nasco-refrigerateur-combine-309-litres-distributeur-deau-hnasd2-40wd-garantie-12-mois-accueil.jpg"},
